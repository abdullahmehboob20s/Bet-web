  ...
  return (
    <div className="visuals h-[70px] px-7px rounded">
      <div className="flex items-center relative h-full">
        <ul className="time-line-separators-bc w-full h-[30px] z-10 flex items-center justify-between relative">
          <li data-time="0">
        ...
        <div className="time-line-match-bc" style={{ width: "7%" }}></div>

        <ul className="time-line-icons-bc">
          <BsSdCardFill
